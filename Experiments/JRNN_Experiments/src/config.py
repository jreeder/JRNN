...
outpath3 = basepath + r"/Experiments/Results/Exp 2-1/Round 11/" #8 is best run 9 is new csmtl stuff 10 is all ds with csmtl ccmtl and etamtl and stltests
#Round 11 has the new experiments with more impoverished sets. 
