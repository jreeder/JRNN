...
namespace JRNN {
	...
	DualKBCCTrainer::reverbdpoint DualKBCCTrainer::ReverberateNetwork(strings subView /*= strings(0)*/ )
	{
	...
	JRNN::DatasetPtr DualKBCCTrainer::ReverbMainNet( int numTrain, int numVal /*= 0*/, strings subView /*= strings(0)*/ )
	{
		matDouble newInputs;
		matDouble newOutputs;
