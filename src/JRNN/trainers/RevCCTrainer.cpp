...
namespace JRNN {
	...
	RevCCTrainer::reverbdpoint RevCCTrainer::ReverberateNetwork( strings subView /*= strings(0)*/ )
	{
	...
	JRNN::DatasetPtr RevCCTrainer::ReverbMainNet( int numTrain, int numVal /*= 0*/, strings subView /*= strings(0) */ )
	{
		matDouble newInputs;
		matDouble newOutputs;
