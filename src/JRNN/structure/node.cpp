...
//bool Node<T>::addConnection(node* newNodeCon, double conWeight){
...
//}
//
//bool Node<T>::addConnections(nodeList inNodes, vector<double> conWeights){
//    //TODO: add tests to make sure size constraints are met.
//    inputNodes = inNodes;
...
//vector<double> Node<T>::vecMul(vector<double> vec1, vector<double> vec2){
